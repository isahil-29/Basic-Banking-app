...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDataBase.execSQL("INSERT INTO customers VALUES('C101','Sahil', 'sahil01sn@gmail.com',556688955,'J&K Bank',200000.50)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C102','Jay', 'jayS@gmail.com',9057893984,'SBI Bank',190000.75)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C103','Kabir', 'kabir2020@gmail.com',8130677890,'HDFC Bank',105500.00)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C104','Priyanka', 'priyankapr@gmail.com',9154780245,'ICICI Bank',100000.75)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C105','Nisha', 'nishi@gmail.com',8024381038,'Axis Bank',205000.55)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C106','Samarth', 'samK10@gmail.com',9142630714,'Axis Bank',204001.00)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C107','Veer', 'veer1234@gmail.com',9818567890,'HDFC Bank',107000.00)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C108','Navya', 'navyaNew@gmail.com',9872438457,'SBI Bank',108005.75)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C109','Shruti', 'shruutii@gmail.com',8130452789,'PNB Bank',205000.00)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C110','Rahul', 'rahulS15@gmail.com',9540994466,'ICICI Bank',244500.60)");
        myDataBase.execSQL("INSERT INTO customers VALUES('C111','Ravi', 'ravi1001@gmail.com',9678923340,'ICICI Bank',257899.90)");
